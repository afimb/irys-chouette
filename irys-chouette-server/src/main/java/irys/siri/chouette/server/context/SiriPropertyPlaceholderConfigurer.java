package irys.siri.chouette.server.context;
...
public class SiriPropertyPlaceholderConfigurer extends ServletContextPropertyPlaceholderConfigurer 
{
	private static final Logger logger = Logger.getLogger(SiriPropertyPlaceholderConfigurer.class);
	...
	protected void loadProperties(Properties props) throws IOException 
	{
		...
		if (contextName != null) {
			...
			logger.info("irysConfigRootPath = "+irysConfigRootPath);
			if (irysConfigRootPath != null) {
				...
				logger.info("irysConfig = "+irysConfig);
